...
<!--   <a href="aitimis.netlify" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=WEBSITE&color=cdf998&style=plastic&logo=wordpress&logo-color=white"/>
        ...
        <p><strong>HTML5, CSS3, Javascript</strong> - Hair salon website with a user-friendly interface that allows your customers to easily book appointments!</p>
    </td> 
      <!-- Star Wars Quotes -->
    <td width="50%" valign="top">
      <h3 align="center">Darth Vader invades!</h3>
        <br />
        <a target="_blank" href="">
          <img src="images/starWarsQuotes.gif" width="100%" alt="Matching Cards"/>
        </a>
        <br />
        <p align="center">  
